...
.stApp {
    background:
        radial-gradient(ellipse 120% 80% at 50% -20%,
            rgba(45, 70, 130, 0.22) 0%, transparent 55%),
        radial-gradient(circle at 85% 15%,
            rgba(90, 60, 140, 0.12) 0%, transparent 35%),
        radial-gradient(circle at 10% 80%,
            rgba(40, 90, 130, 0.10) 0%, transparent 40%),
...
.stApp::before {
    ...
    z-index: 0;
    background-image:
        radial-gradient(1px 1px at 20px 30px,
            rgba(255,255,255,0.35), transparent),
        radial-gradient(1px 1px at 80px 120px,
            rgba(255,255,255,0.25), transparent),
        radial-gradient(1px 1px at 160px 60px,
            rgba(255,255,255,0.20), transparent),
        radial-gradient(1px 1px at 240px 180px,
            rgba(255,255,255,0.30), transparent),
        radial-gradient(1px 1px at 320px 40px,
            rgba(255,255,255,0.18), transparent),
        radial-gradient(1px 1px at 400px 140px,
            rgba(255,255,255,0.22), transparent),
        radial-gradient(1.5px 1.5px at 500px 90px,
            rgba(200,220,255,0.35), transparent),
        radial-gradient(1px 1px at 600px 200px,
            rgba(255,255,255,0.20), transparent);
...
[data-testid="stSidebar"] {
    ...
    border-right: 1px solid var(--space-panel-border);
}
...
.hero-status-item { text-align: center; }
...
[data-testid="stChatMessageAvatarAssistant"] {
    background: rgba(107, 159, 212, 0.15) !important;
...
[data-testid="stChatMessage"]:has(
    ...
    background: var(--space-panel) !important;
    border: 1px solid var(--space-panel-border);
...
[data-testid="stTextInput"] input {
    ...
    border: 1px solid rgba(120, 150, 210, 0.22) !important;
...
[data-testid="stTextInput"] input:focus {
    border-color: rgba(107, 159, 212, 0.45) !important;
    background: rgba(16, 23, 41, 0.98) !important;
    box-shadow: none !important;
}
...
/* PLUS BUTTON */
[data-testid="stPopover"] { margin-bottom: 0 !important; }
...
[data-testid="stPopover"] > button:hover {
    background: rgba(107, 159, 212, 0.14) !important;
...
[data-testid="stPopoverBody"] {
    ...
    border: 1px solid var(--space-panel-border) !important;
...
[data-testid="stFileUploader"] {
    ...
    border: 1px dashed rgba(107, 159, 212, 0.30);
    border-radius: 10px;
    padding: 0.5rem;
}
...
[data-testid="stFileUploader"] button {
    ...
    border: 1px solid rgba(107, 159, 212, 0.25) !important;
}
...
def render_context_chunks(
    ...
    for chunk in chunks:
        ...
        heading_html = (
            f" — <em>{html.escape(str(heading))}</em>"
            if heading
            else ""
        )
